export const charityData = [
  {
    ...
    icon_bg: "w-20 h-20 bg-red-100 rounded-2xl flex items-center justify-center mb-6",
  ...
  },
  {
    ...
    icon_bg: "w-20 h-20 bg-green-100 rounded-2xl flex items-center justify-center mb-6",
  ...
  },
  {
    ...
    icon_bg: "w-20 h-20 bg-blue-100 rounded-2xl flex items-center justify-center mb-6",
    partner: "Фонд «Надежда для детей»",
    description:
      "Поддержка программ здравоохранения и образования для детей по всей стране. Ваше участие помогает обеспечить медицинскую помощь и образовательные ресурсы детям, которым это нужно.",
